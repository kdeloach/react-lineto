...
export default class LineTo extends Component {
  ...
  parseAnchor(value) {
    ...
    const parseY = y
      ...
      : {};
    return Object.assign({}, defaultAnchor, parseX, parseY);
  }
...
LineTo.propTypes = Object.assign({}, LineToProps, optionalStyleProps);
...
Line.propTypes = Object.assign({}, LineProps, optionalStyleProps);
...
SteppedLine.propTypes = Object.assign({}, SteppedLineProps, optionalStyleProps);
